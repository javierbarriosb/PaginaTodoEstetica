...
class CreateProduct(forms.ModelForm):
 ...
 class Meta:
        ...
        widgets={
            'NombreProducto':forms.TextInput(attrs={'class':'form-control','placeholder':'Nombre De Producto'}),
            ...
            'imagen':forms.ImageField(widget=forms.FileInput(attrs={'class': 'rounded_list'}))
        }
